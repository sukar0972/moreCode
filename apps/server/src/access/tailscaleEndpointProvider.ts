...
type NetworkInterfaces = ReturnType<typeof NodeOS.networkInterfaces>;
...
export const resolveTailscaleAdvertisedEndpoints = Effect.fn("resolveTailscaleAdvertisedEndpoints")(
  function* (input: {
    ...
    readonly servePort?: number;
    readonly networkInterfaces: NetworkInterfaces;
    readonly includeIpEndpoints?: boolean;
    readonly statusJson?: string | null;
    readonly readMagicDnsName?: Effect.Effect<string | null, never, never>;
    readonly probe?: (baseUrl: string) => Effect.Effect<boolean, never, HttpClient.HttpClient>;
  }): Effect.fn.Return<
    readonly AdvertisedEndpoint[],
    never,
  ...
  > {
    const ipEndpoints =
      input.includeIpEndpoints === false ? [] : resolveTailscaleIpAdvertisedEndpoints(input);
    const readDnsName =
